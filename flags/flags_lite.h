...
//#define USE_INTERNAL_NTFS_PLUGIN	1	// comment out to use internal rawseciso & netiso clients when raw_iso.sprx & netiso.sprx are unavailable
...
#define LAST_FIRMWARE_ONLY 1	// support only 4.84-4.88 CEX / DEX (no FIX_GAME)
