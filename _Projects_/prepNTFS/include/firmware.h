...
static void detect_firmware(void)
{
	...
	if(peekq(0x80000000002ED818ULL)==CEX) {c_firmware=(peekq(0x80000000002FCB68ULL)==0x323031372F30382FULL)?4.82f:(peekq(0x80000000002FCB68ULL)==0x323031362F31302FULL)?4.81f:(peekq(0x80000000002FCB68ULL)==0x323031352F31322FULL)?4.78f:(peekq(0x80000000002FCB68ULL)==0x323031352F30382FULL)?4.76f:4.75f;} else
