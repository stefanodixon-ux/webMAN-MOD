...
static void detect_firmware(void)
{
	...
	if(peekq(0x800000000030F3B0ULL)==DEX) {c_firmware=(peekq(0x800000000031F028ULL)==0x323031392F30312FULL)?4.84f:(peekq(0x800000000031F028ULL)==0x323031372F30382FULL)?4.82f:(peekq(0x800000000031F028ULL)==0x323031362F31302FULL)?4.81f:4.84f;;dex_mode=2;}	else
